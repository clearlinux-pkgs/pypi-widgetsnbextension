...
Version  : 4.0.1
Release  : 75
URL      : https://files.pythonhosted.org/packages/a3/a6/742ef54166337e374481b2610a7dfcd6c01135d5c7896b132ced2156f65c/widgetsnbextension-4.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/a3/a6/742ef54166337e374481b2610a7dfcd6c01135d5c7896b132ced2156f65c/widgetsnbextension-4.0.1.tar.gz
...
%prep
%setup -q -n widgetsnbextension-4.0.1
cd %{_builddir}/widgetsnbextension-4.0.1
%patch1 -p1
pushd ..
cp -a widgetsnbextension-4.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661186254
