...
Source0  : https://files.pythonhosted.org/packages/46/d0/ef509e5b74d96821b4ec170b7785449e25a89ef0e781e80562e515f84678/widgetsnbextension-4.0.5.tar.gz
...
%prep
%setup -q -n widgetsnbextension-4.0.5
cd %{_builddir}/widgetsnbextension-4.0.5
%patch1 -p1
pushd ..
cp -a widgetsnbextension-4.0.5 buildavx2
cp -a widgetsnbextension-4.0.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671726837
