...
Version  : 4.0.11
Release  : 93
URL      : https://files.pythonhosted.org/packages/52/f4/b261824abd9c9b22d328c576bfa57f09142b2bca422b013abc13bd6d87ac/widgetsnbextension-4.0.11.tar.gz
Source0  : https://files.pythonhosted.org/packages/52/f4/b261824abd9c9b22d328c576bfa57f09142b2bca422b013abc13bd6d87ac/widgetsnbextension-4.0.11.tar.gz
...
%prep
%setup -q -n widgetsnbextension-4.0.11
cd %{_builddir}/widgetsnbextension-4.0.11
%patch -P 1 -p1
pushd ..
cp -a widgetsnbextension-4.0.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716909023
