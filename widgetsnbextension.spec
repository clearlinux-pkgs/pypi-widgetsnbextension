...
Version  : 3.0.0
Release  : 4
URL      : https://pypi.debian.net/widgetsnbextension/widgetsnbextension-3.0.0.tar.gz
Source0  : https://pypi.debian.net/widgetsnbextension/widgetsnbextension-3.0.0.tar.gz
...
%prep
%setup -q -n widgetsnbextension-3.0.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1503087480
